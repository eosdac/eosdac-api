...
const fixtures = require('../fixtures/voters.fixture');
...
describe('Voters API Test', () => {
  it('should return status 200', async () => {
    const response = await getApiResponse(Api.method, `${Api.url}?candidate=${Data.Candidate}`)
  ...
  it('should return error if candidate is not provided', async () => {
    ...
    expect(jsonResp.message).toEqual("querystring should have required property 'candidate'")
  });
});
