...
const profileDto: ActionDocument = {
  block_num: Long.ZERO,
  action: {
    authorization: null,
    account: "dao.worlds",
    ...
    expect(profile.toDto()).toEqual({
      ...
      action: {
        ...
        data: {
          cand: 'awtesteroo12',
          profile: {
            description: "Here's a description of this amazing candidate with the name: awtesteroo12.\n" +
              " And here's another line about something.",
            familyName: 'awtesteroo12Family Name',
            givenName: 'awtesteroo12 name',
            image: 'https://support.hubstaff.com/wp-content/uploads/2019/08/good-pic.png'
          }
        }
      }
    });
