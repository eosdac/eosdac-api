...
async function memberSnapshot(fastify, request) {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        const symbol = request.query.symbol || (dac_config.symbol.sym || dac_config.symbol.symbol).split(',')[1];
        const precision = parseInt((dac_config.symbol.sym || dac_config.symbol.symbol).split(',')[0]);
